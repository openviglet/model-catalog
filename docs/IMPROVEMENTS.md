...
## §VI Client libraries / SDKs (T11 Java)

> T9 (JS/TS) and T10 (Python) shipped — see [CHANGELOG.md](CHANGELOG.md) → Block B.
> The shared design below still governs the remaining Java client.
