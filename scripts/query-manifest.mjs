...
const DESCRIPTIONS = {
  ...
  benchmarks_intelligenceIndex: "Overall intelligence index — THE metric for ranking how intelligent / capable / smart a model is (higher is better). Use this alone for 'most intelligent'; it is NOT a per-domain sub-score.",
  benchmarks_scores_coding_value: "Coding-domain benchmark sub-score only — NOT the overall intelligence index.",
  benchmarks_scores_math_value: "Math-domain benchmark sub-score only — NOT the overall intelligence index.",
  benchmarks_scores_reasoning_value: "Reasoning-domain benchmark sub-score only — NOT the overall intelligence index.",
